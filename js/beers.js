const brews = [
  {
    ...
    ingredients3:
      "<h5>Yeast:</h5><br> 1 sachet of Saccharomyces pastorianus, (lager yast)",
  ...
  },
  {
    ...
    ingredients3:
      "<h5>Yeast:</h5><br> 1 sachet of Saccharomyces cerevisiae, (Ale yast).",
    specialtyIngredients:
      "<h5>Specialty Ingredients:</h5> 4oz. Brewers Best Natural coffee Flavoring.",
  },
  {
    style: "whisky barrel stout",
    image: "images/beer/WhiskyBarrelStout.jpg",
    ...
    ingredients3:
      "<h5>Yeast:</h5><br> 1 sachet of Saccharomyces cerevisiae, (Ale yast).",
    specialtyIngredients:
      "<h5>Specialty Ingredients:</h5> Oak Chips, 2.5 oz Whisky Barrel Chips.",
  },
  {
    style: "dunkelweizen",
  ...
  },
  {
    ...
    ingredients3:
      "<h5>Yeast:</h5><br> 1 sachet of Saccharomyces cerevisiae, (Ale yast).",
    specialtyIngredients:
      "<h5>Specialty Ingredients:</h5> 4oz. Brewers Best Natural Grapefruit Flavoring.",
  },
  {
    ...
    ingredients3:
      "<h5>Yeast:</h5><br> 1 sachet of Saccharomyces cerevisiae, (Ale yast).",
    specialtyIngredients: "<h5>Specialty Ingredients:</h5> 2.oz Oak Chips.",
  },
  {
    style: "belgian ipa",
  ...
  },
  {
    ...
    ingredients2:
      "<h5>Hops:</h5><br> 1oz. German Northern Brewer,<br> .25oz. Czech Saaz",
    ingredients3:
      "<h5>Yeast:</h5><br> 1 sachet of Saccharomyces pastorianus, (lager yast). Recommended: Mangrove Jacks West Coast M44.",
    specialtyIngredients: "<h5>Specialty Ingredients:</h5><br>(optional)",
  },
  {
    style: "red ale",
